...
const PLANS = [
  ...
  },
  {
    ...
    features: [
      '30 causas',
      '600 consultas rápidas/mes',
      '60 análisis completos/mes',
      '15 análisis expertos/mes',
      'Retención permanente',
    ],
    cta: 'Suscribirse',
    href: '/login',
  ...
  },
  {
    ...
    features: [
      '100 causas',
      '1.000 consultas rápidas/mes',
      '150 análisis completos/mes',
      '30 análisis expertos/mes',
      'Retención permanente',
    ],
    cta: 'Suscribirse',
    href: '/login',
      ...
      <nav className="sticky top-0 z-50 border-b border-slate-100 bg-white/90 backdrop-blur-sm">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
          <Link href="/" className="flex items-center gap-3">
            <Image src="/caussa-logo.png" alt="Caussa" width={120} height={32} priority className="h-7 w-auto" />
          </Link>
      ...
      <footer className="border-t border-slate-200 bg-white py-12">
        <div className="mx-auto flex max-w-6xl flex-col items-center gap-6 px-6 sm:flex-row sm:justify-between">
          <div className="flex items-center gap-3">
            <Image src="/caussa-logo.png" alt="Caussa" width={100} height={26} className="h-5 w-auto" />
          </div>
